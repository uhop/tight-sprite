...
var bsearch = require("heya-ctr/algos/binarySearch"),
	qsort   = require("heya-ctr/algos/quickSort");


var searchByWidth  = bsearch("a.w < b.w").compile(),
	searchByHeight = bsearch("a.h < b.h").compile(),
	sortByWidth  = qsort("a.w < b.w").compile(),
	sortByHeight = qsort("a.h < b.h").compile();
